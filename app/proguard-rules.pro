...
#---------------------------------实体类---------------------------------
#修改成你对应的包名
-keep class com.kiwilss.pujin.model.** { *; }
-keep class com.kiwilss.pujin.ui.**{*;}
...
-keepclassmembers class com.kiwilss.pujin.MyApp {
    public <init>();
}
...
#-keep class com.just.agentweb.AuthResult{*;}
#-keep class com.just.agentweb.AuthResult2{*;}
#-keep class com.just.agentweb.Contact{*;}
#-keep class com.just.agentweb.CustomerContact{*;}
...
-keep class com.just.agentweb.GsonUtils{ *;}
...
-dontwarn com.iflytek.**
-keep class top.limuyang2.unionpaylibrary.** {*;}
-keep class top.limuyang2.basepaylibrary.** {*;}
...
#agentweb
-keep class com.kiwilss.agentweb.** {*;}
#agentwevx5
...
-keep class com.kiwilss.pujin.widget.**{*;}
